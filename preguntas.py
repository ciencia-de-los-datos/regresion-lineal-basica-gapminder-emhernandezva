...
def pregunta_03():
    ...
    prediction_space = np.linspace(
        X_fertility.min(),
        X_fertility.max(),X_fertility.shape[0]).reshape(-1,1)
...
def pregunta_04():
    ...
    # Lea el archivo `gm_2008_region.csv` y asignelo al DataFrame `df`
    df = pd.read_csv('/content/drive/MyDrive/Especialización Analítica/Ciencia de los Datos Aplicada/Talleres/Taller 7/gm_2008_region.csv')
